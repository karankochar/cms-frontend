...
export default class AddPage extends Component {
    ...
    componentDidMount(){
        ...
        .then((res)=>{
            ...
            this.setState({ page: { ...this.state.page, author:{...this.state.page.author, userId: userId}}})
            this.setState({ page: { ...this.state.page, author:{...this.state.page.author, userName: userName}}})
        }).catch((err)=>{alert(err)})
    ...
    validate = () => {
      ...
      handleSubmit = async (event) => {
        ...
        this.service.addPage(this.state.page.author.userId, this.state.page.category.categoryId, this.state.page)
        .then((res)=>{
    ...
    render() {
        ...
        <div className="form-group">
          <div className="alert-danger">{this.state.error.titleError}</div>
          ...
          <input
            ...
            onChange={(event) =>
             this.setState({ page: { ...this.state.page, pageTitle: event.target.value } })
            
            }
          />
        </div>
        <div className="form-group">
          <div className="alert-danger">{this.state.error.contentError}</div>
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={(event) =>
              this.setState({ page: { ...this.state.page, category: { ...this.state.page.category, categoryId: event.target.value } } })
            }
          >
